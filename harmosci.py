...
#en bredde pÃ¥ ca 200 Ã…, og har verdien 1 eV i posisjon +- 100 Ã…. 
#PÃ¥ hver side av dette er det et omrÃ¥de med konstant 
#potensial og bredde 400 Ã…. Utenfor dette igjen
#er potensialet uendelig. Partikkelen har masse lik elektronmassen. 
#Problemet lÃ¸ses ved Ã¥ diskretisere den 2. deriverte, som
#inngÃ¥r i operatoren for kinetisk energi. Den resulterende Hamiltonmatrisen H
...
m=9.11E-31
V0=1.6E-19
#N = 100 = antall posisjonsverdier i halve det harmoniske omrÃ¥det
N=100
#dz = 1 Ã… = intervallbredde
dz=1E-10
...
#psi0 = bÃ¸lgefunksjonen til grunntilstanden, psi1 = 1. eksiterte tilstand osv
psi0 = v[:,0]
psi1 = v[:,1]
psi2 = v[:,2]
psi3 = v[:,3]
...
#null-nivÃ¥ forskjÃ¸vet med energiverdien, for Ã¥ gi en bra figur
...
plt.show()
plt.title('Navn: Jon Andreas StÃ¸vneng',fontsize=20)
